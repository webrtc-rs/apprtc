...
pub fn tls_pem(certificate: &str, private_key: &str) -> anyhow::Result<(Vec<u8>, Vec<u8>)> {
...
pub fn tls_config(certificate: &str, private_key: &str) -> anyhow::Result<Arc<ServerConfig>> {
