...
ExecStart=/opt/apprtc/target/release/sfu --host-ip 0.0.0.0 --port 443 --tls --redirect-url https://appr.tc:443 --media-public-ip 173.249.204.140 --media-port-min 3478 --media-port-max 3495 --grpc-url https://appr.tc:50051 -d -l info -o /opt/logs/sfu.log
Restart=always
RestartSec=5
KillSignal=SIGINT
TimeoutStopSec=30
